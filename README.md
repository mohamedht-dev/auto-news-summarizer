...
## ما الجديد في الإصدار 0.5

- حفظ الأخبار محليًا على الجهاز في قائمة قراءة خاصة، من دون حساب أو تتبع.
- مشاركة الخبر مباشرة أو نسخ رابطه تلقائيًا عند غياب قائمة المشاركة.
- تطبيق ويب تقدمي PWA قابل للتثبيت، مع غلاف أساسي للعمل عند ضعف الاتصال.
- موضوعات رائجة مستخرجة من الشركات والتقنيات المذكورة في آخر الأخبار.
- تقدير مدة القراءة لكل موجز وواجهة إحصاءات عامة على `/api/stats`.
...
| `/saved` | قائمة الأخبار المحفوظة محليًا على الجهاز |
...
| `/api/stats` | إحصاءات المنصة والموضوعات الرائجة |
